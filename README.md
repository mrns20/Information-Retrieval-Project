...
Clone the repository and install the dependencies, then run the main script with `python project_final_version.py`.
...
Κλωνοποιήστε το αποθετήριο, εγκαταστήστε τις εξαρτήσεις και εκτελέστε το κύριο script με `python project_final_version.py`. 
